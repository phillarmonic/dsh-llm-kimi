/**
 * Translate Kimi SSE payloads with one stateful harness block per content,
 ...
 *
 * @module @phillarmonic/dsh-llm-kimi/translate
 */
...
/**
 * Map wire usage fields into the harness disjoint-count convention: cache
 * reads are subtracted out of `inputTokens` when the wire reports them.
